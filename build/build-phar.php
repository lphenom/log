...
/**
 * PHAR build script for lphenom/log.
 *
...
$pharFile = $buildDir . '/lphenom-log.phar';

if (file_exists($pharFile)) {
    unlink($pharFile);
}

$phar = new Phar($pharFile, 0, 'lphenom-log.phar');
$phar->startBuffering();
...
$stub = <<<'STUB'
<?php
Phar::mapPhar('lphenom-log.phar');
require 'phar://lphenom-log.phar/vendor/autoload.php';
__HALT_COMPILER();
STUB;
